...
extension Category {
    ...
    static let restauraunts = Category(id: 502, name: "restaurants", icon: .utensils, mainCategoryId: 5)
    ...
    static let creditCardPaymet = Category(id: 901, name: "Credit Card Payment", icon: .exchange_alt, mainCategoryId: 9)
